...
const Cart = () => {
  ...
  // console.log("totalPrice ", totalPrice)
      ...
      const response = await fetch("http://localhost:3000/api/order/create-order", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="space-y-4 mb-8">
        {cart.map((item) => (
          <div key={item._id} className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
      ...
      <div className="mt-6 bg-white p-6 rounded-lg shadow-md max-w-md mx-auto">
        <h3 className="text-lg font-semibold mb-4 text-green-800">Customer Details</h3>
