...
//   //  Get cart items to display real-time count
...
//                 {/*  ORIGINAL ADD TO CART BUTTON STYLE */}
//                 <button
//                   onClick={() => {
...
//       {/* 4. FIXED VIEW ORDER BUTTON (ORANGE STYLE WITH PRICE) */}
//       {cartCount > 0 && (
